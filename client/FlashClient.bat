...
$linux_steam = $HOME + "/.steam/steam/steamapps/common/Ninja Kiwi Archive/resources"
$linux_steam2 = $HOME + "/.local/share/Steam/steamapps/common/Ninja Kiwi Archive/resources"
$linux_proton = $HOME + "/.steam/steam/steamapps/compatdata/1275350/pfx/drive_c/Program Files (x86)/Steam/steamapps/common/Ninja Kiwi Archive/resources"
